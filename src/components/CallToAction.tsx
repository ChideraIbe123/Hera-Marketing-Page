            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center md:justify-between gap-12">
              <div className="md:w-1/2">
                ...
                <p className="text-white/80 mb-8">
                  Ready to discover who's really driving your success? HeraAI
                  reveals the hidden heroes and collaboration networks that
                  traditional HR analytics miss.
                </p>
                    ...
                    {[
                      {
                        ...
                        title: "Connect",
                        description:
                          "Integrate with all your existing tools and platforms",
                      },
                      {
                        icon: <Heart className="h-6 w-6 text-white" />,
                        title: "Analyze",
                        description:
                          "Discover collaboration patterns and key contributors",
                      },
                      {
                        icon: <TrendingUp className="h-6 w-6 text-white" />,
                        title: "Transform",
                        description:
                          "Make better decisions based on complete insights",
                      },
                    ].map((item, i) => (
                      <div
                        key={i}
